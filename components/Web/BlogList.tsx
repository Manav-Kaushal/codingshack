            ...
            <div className="flex flex-col overflow-hidden cursor-pointer group">
              <div className="relative w-full h-80 drop-shadow-xl">
                <Image
                  ...
                  className="object-cover object-left lg:object-center filter grayscale group-hover:grayscale-0 transition-200"
                ...
                <div className="absolute bottom-0 flex justify-between w-full p-5 text-white bg-black rounded bg-opacity-20 backdrop-blur-lg drop-shadow-lg">
                  ...
                  <div className="flex flex-col items-center md:flex-row gap-y-2 md:gap-x-2">
                    {post.categories.map((category) => (
                      <div className="px-3 py-1 text-sm font-semibold text-center text-white rounded-full bg-brand">
                        <p>{category.title}</p>
                      </div>
                    ))}
                  </div>
